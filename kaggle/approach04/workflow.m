...
patient1dtree = fitrtree([features.avmean(:, :), features.std(:, :), features.skewness(:, :), features.kurtosis(:, :), features.activity(:, :), features.mobility(:, :), features.complexity(:, :), features.shentropy(:, :), features.spedge(:, :), features.shentropyDyd(:, :)], Y);
...
patient2dtree = fitrtree([features.avmean(:, :), features.std(:, :), features.skewness(:, :), features.kurtosis(:, :), features.activity(:, :), features.mobility(:, :), features.complexity(:, :), features.shentropy(:, :), features.spedge(:, :), features.shentropyDyd(:, :)], Y);
...
patient3dtree = fitrtree([features.avmean(:, :), features.std(:, :), features.skewness(:, :), features.kurtosis(:, :), features.activity(:, :), features.mobility(:, :), features.complexity(:, :), features.shentropy(:, :), features.spedge(:, :), features.shentropyDyd(:, :)], Y);
...
prediction_1 = predict(patient1dtree, [features.avmean(:, :), features.std(:, :), features.skewness(:, :), features.kurtosis(:, :), features.activity(:, :), features.mobility(:, :), features.complexity(:, :), features.shentropy(:, :), features.spedge(:, :), features.shentropyDyd(:, :)]);
   
features_file = load('/Users/Gale/Documents/Seizure-Prediction/features/features_test_2.mat');
features = features_file.features;

prediction_2 = predict(patient2dtree, [features.avmean(:, :), features.std(:, :), features.skewness(:, :), features.kurtosis(:, :), features.activity(:, :), features.mobility(:, :), features.complexity(:, :), features.shentropy(:, :), features.spedge(:, :), features.shentropyDyd(:, :)]);

features_file = load('/Users/Gale/Documents/Seizure-Prediction/features/features_test_3.mat');
features = features_file.features;

prediction_3 = predict(patient3dtree, [features.avmean(:, :), features.std(:, :), features.skewness(:, :), features.kurtosis(:, :), features.activity(:, :), features.mobility(:, :), features.complexity(:, :), features.shentropy(:, :), features.spedge(:, :), features.shentropyDyd(:, :)]);
 
fileID = fopen('/Users/Gale/Documents/Seizure-Prediction/approach04/submission.csv','wt');
